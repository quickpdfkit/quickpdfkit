      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-black text-base sm:text-lg">
            This Cookie Policy explains how PDFTools uses cookies and similar
        ...
        >
          ...
          <p className="text-gray-700 text-sm sm:text-base">
            PDFTools uses cookies to personalize your experience, improve site functionality, and analyze performance. By continuing to use our services, you consent to the use of cookies in accordance with this policy.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-700 text-sm sm:text-base">
            By using PDFTools, you consent to our use of cookies as described in this Cookie Policy. You may withdraw your consent at any time by adjusting your browser settings.
          </p>
        </motion.div>
      </div>
    </section>
