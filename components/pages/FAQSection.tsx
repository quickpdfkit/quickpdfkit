...
export default function FAQSection() {
  const faqs = [
    ...
    {
      question: "Do I need an account to use PDFTools?",
      answer:
    ...
    },
    {
      ...
      answer:
        "PDFTools works on all modern browsers and devices. You can use it on Windows, Mac, Linux, iOS, and Android without installing any software. We also offer dedicated apps for iLovePDF Desktop and iLovePDF Mobile for even more convenience.",
    },
  ];
      ...
      <div className="max-w-5xl mx-auto">
        <div className="mt-20">
          ...
          <p className="text-black text-center ">
            ...
            compiled a list of the most common inquiries about using PDFTools.
